...
// Source: jukebox-app/pkg/environment (interfaces: Environment)
...
func (m *MockEnvironment) GetValue(arg0 string) EnvVar {
	m.ctrl.T.Helper()
...
func (m *MockEnvironment) GetValueOrDefault(arg0, arg1 string) EnvVar {
	m.ctrl.T.Helper()
