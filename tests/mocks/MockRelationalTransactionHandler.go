...
import (
	transaction "jukebox-app/pkg/transaction"
	reflect "reflect"
...
func (m *MockRelationalTransactionHandler) HandleTransaction(arg0 transaction.RelationalTransactionHandlerFunction) error {
	m.ctrl.T.Helper()
